...
namespace Halley.CapaDatos.Ventas
{
    public class CD_Comprobante
    {
        ...
        public DataTable getTipoComprobanteVentas()
        {
            DataTable dtTmp = new DataTable();
            SqlDatabase SqlClient = new SqlDatabase(connectionString);
            DbCommand SqlCommand = SqlClient.GetStoredProcCommand("Ventas.Usp_get_TipoComprobanteVentas");
        ...
        public DataTable ActualizarComprobanteSunat(int ComprobanteId, string EnviadoSunat, string MensajeSunat)
        {
            ...
            SqlClient.AddInParameter(SqlCommand, "@MensajeSunat", SqlDbType.Char, MensajeSunat);
