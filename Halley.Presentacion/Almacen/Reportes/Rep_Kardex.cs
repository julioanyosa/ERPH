    ...
    public partial class Rep_Kardex : UITemplateAccess
    {
        ...
        private void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            if (RbRAngo.Checked == true)
            {
                ...
                FecFinal = Convert.ToDateTime(this.dtpFinal.Value.AddDays(1).ToShortDateString()).AddSeconds(-1);
            }
            else if (RbPeriodo.Checked == true)
            {
                ...
                FecFinal = new DateTime(Convert.ToInt16(CboAnno.SelectedValue.ToString()), Convert.ToInt16(CboPeriodo.SelectedValue.ToString()), 1).AddMonths(1).AddSeconds(-1);
            }
        ...
        private void BtnMostrar_Click(object sender, EventArgs e)
        {
            ...
            MostrarKardex("", FecInicial, FecFinal);
        }
        ...
        private void MostrarKardex(string tipo, DateTime FecInicial, DateTime FecFinal)
        {
            Cursor = Cursors.WaitCursor;
            try
            {
                if (dtpInicial.Value != null & dtpFinal.Value != null)
                {
                    ...
                    ObjFrmKardexValorizado.Tipo = tipo;
                    ObjFrmKardexValorizado.Ds = Ds;
                    ObjFrmKardexValorizado.Titulo = "Periodo " + FecInicial.ToShortDateString() + " Y " + FecFinal.ToShortDateString();
        ...
        private void BtnReporteInventarioResumido_Click(object sender, EventArgs e)
        {
            ProductoId = "";
