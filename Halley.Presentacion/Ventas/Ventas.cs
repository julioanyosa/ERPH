...
namespace Halley.Presentacion.Ventas
{
    public partial class Ventas : UITemplateAccess
    {
        ...
        { 
            ...
            DtDetalleComprobante.Columns.Add("Cantidad", typeof(decimal)).DefaultValue = 0.00;
            DtDetalleComprobante.Columns.Add("PrecioUnitario", typeof(decimal));
            DtDetalleComprobante.Columns.Add("Importe", typeof(decimal)).DefaultValue = 0.00;
            ...
            DtDetalleComprobante.Columns.Add("Descuento", typeof(decimal)).DefaultValue = 0.00;
            ...
            //tarer empresas
            Dtempresas = new CL_Empresas().GetEmpresasVentas();
            ...
            if (NroTerminales == 1 | NroTerminales == 3)
            {
                ...
                DtTipoDocumento = ObjComprobante.getTipoComprobanteVentas();
            ...
            try
            {
                ...
                if (NroTerminales == 1 | NroTerminales == 3)//la venta y la caja son la misma
                {
                    ...
                    if (ClienteID != -1 & CboTipoComprobante.ComboBox.SelectedValue != null & CboSerieGuia.ComboBox.SelectedValue != null & DtDetalleComprobante.Rows.Count > 0 & NumCaja != 0 & haycero == false & CboFormaPago.SelectedIndex != -1)
                    {
                        ...
                        {
                            MessageBox.Show("En caso de boleta debe ser DNI, En caso de Factura o Ticket Factura solo RUC. Ticket Boleta acepta cualquiera.", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                            return;
                        }
                        ...
                        //guardamos el nombre del cliente en comprobante
                        if (TxtNombresRapido.Text.Trim() != "")
                            ObjCL_Venta.InsertClienteBoleta(Convert.ToInt64(dt.Rows[0]["ComprobanteId"]), TxtNombresRapido.Text.Trim(), "C");
                        ...
                        //envia factura digital
                        //if (ObjCL_Venta.HABILITADOFE())
                        //{
                        //   ObjCL_Venta.GenerarFE(Convert.ToInt32(CboTipoComprobante.ComboBox.SelectedValue), NumComprobante, null, null, EmpresaID, NuevaIP);
                        //}
                ...
                else if (NroTerminales == 2)//la venta y la caja son diferentes
                {
                    if (ClienteID != 0 & DtDetalleComprobante.Rows.Count > 0 & haycero == false & VendedorID != 0)
                    {
                        ...
                        //guardamos el nombre del cliente en comprobante
                        if (TxtNombresRapido.Text.Trim() != "")
                            ObjCL_Venta.InsertClienteBoleta(NumPedido, TxtNombresRapido.Text.Trim(), "P");

                        PnlUsuarioRapido.Visible = true;
                        TxtNombresRapido.Text = "";
                        PnlUsuarioRapido.Visible = false;
        ...
        private void CalcularTotales()
        {
            if (DtDetalleComprobante.Rows.Count > 0)
            {
                ...
                if (EmpresaID == "IH")
                    TxtMontoPagado.Text = TotalPagar.ToString("N2");
                else
                    TxtMontoPagado.Text = "0";
            ...
            else
            {
                ...
                TxtIGV.Text = 0.ToString("C");
                TxtValorVenta.Text = 0.ToString("C");
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            if (ObjCL_Venta.HABILITADOFE2(EmpresaID))
            {
                ...
                if (hojaimpresa == 1)
                {
                    ...
                    if (Convert.ToInt16(CboTipoComprobante.ComboBox.SelectedValue) == 4)//es boleta
                    {
                        //if (EmpresaID == "IH")
                        //{
                        //    string Formatoticketanterior = ObjCL_Venta.FormatoTicketFEAnterior(NomEmpresa, AppSettings.NomSede, NumComprobante.Substring(2),
                        ...
                        //     "", ConCliente, FECHA_IMPRESION, Convert.ToDecimal(TxtMontoPagado.Text), TotalIGV, "B", Convert.ToDecimal(TxtVentaNeta.Text), montoimpuestobolsa);
                        //    e.Graphics.DrawString(Formatoticketanterior, TxtFormatoticketera.Font, Brushes.Black, 0, 0); //total pagar en letras 
                        //    return;
                    ...
                    else if (Convert.ToInt16(CboTipoComprobante.ComboBox.SelectedValue) == 5)//es factura
                    {
                        ...
                        //    NroAutorizacion, TotalPagarLetras, TxtRazonSocial.Text,
                        //    TxtNroDocumentoCliente.Text, TxtDireccion.Value.ToString(),
                        //    "", ConCliente, FECHA_IMPRESION, Convert.ToDecimal(TxtMontoPagado.Text), TotalIGV, "F", Convert.ToDecimal(TxtVentaNeta.Text), montoimpuestobolsa);
                        //    e.Graphics.DrawString(Formatoticketanterior, TxtFormatoticketera.Font, Brushes.Black, 0, 0); //total pagar en letras 
                        //    return;
                        //}
                ...
                //    //Convert.ToDecimal(TxtVentaNeta.Text)
                //    string Formatoticket = ObjCL_Venta.FormatoTicketFE(NomEmpresa, AppSettings.NomSede, NumComprobante.Substring(2),
                //    "BOLETA ELECTRONICA: ", DtDetalleComprobante, RUC, AppSettings.Usuario, TotalPagar, NomCaja, SerieEticketera,
                //    NroAutorizacion, TotalComprobanteLetras, ((TxtNombresRapido.Text.Trim() == "") ? useCliente1.cbNombre.Columns["RazonSocial"].Value.ToString() : TxtNombresRapido.Text.Trim()),
                //    useCliente1.cbCliente.Columns["NroDocumento"].Value.ToString(), useCliente1.txtDireccion.Text,
                //    TxtCanasta.Text, ConCliente, FECHA_IMPRESION, Convert.ToDecimal(TxtMontoPagado.Text), Convert.ToDecimal(TxtIGV.Text), "B", TotalComprobante);
                ...
                //    string Formatoticket = ObjCL_Venta.FormatoTicketFE(NomEmpresa, AppSettings.NomSede, NumComprobante.Substring(2),
                //    "FACTURA ELECTRONICA: ", DtDetalleComprobante, RUC, AppSettings.Usuario, Convert.ToDecimal(TxtVentaNeta.Text), NomCaja, SerieEticketera,
                //    NroAutorizacion, TotalComprobanteLetras, ((TxtNombresRapido.Text.Trim() == "") ? useCliente1.cbNombre.Columns["RazonSocial"].Value.ToString() : TxtNombresRapido.Text.Trim()),
                //    useCliente1.cbCliente.Columns["NroDocumento"].Value.ToString(), useCliente1.txtDireccion.Text,
                //    TxtCanasta.Text, ConCliente, FECHA_IMPRESION, Convert.ToDecimal(TxtMontoPagado.Text), Convert.ToDecimal(TxtIGV.Text), "F", TotalComprobante);
                //    e.Graphics.DrawString(Formatoticket, TxtPrecio.Font, Brushes.Black, 0, 0); //total pagar en letras
                //    //e.Graphics.DrawString(Convert.ToChar(27) + "i", TxtPrecio.Font, Brushes.Black, 0, 0); //total pagar en letras
                //}
                //return;
            ...
            if (Convert.ToInt16(CboTipoComprobante.ComboBox.SelectedValue) == 1)//es boleta
            {
                ...
                e.Graphics.DrawString(TotalComprobanteLetras, TxtPrecio.Font, Brushes.Black, 45 + AppSettings.BoletaEjeX, 424 + AppSettings.BoletaEjeY); //tatal pagar en letras
            ...
            else if (Convert.ToInt16(CboTipoComprobante.ComboBox.SelectedValue) == 2)//es factura
            {
                ...
                e.Graphics.DrawString(TotalComprobanteLetras, TxtPrecio.Font, Brushes.Black, 90 + AppSettings.FacturaEjeX, 407 + AppSettings.FacturaEjeY); //total pagar en letras
            }
            #endregion
            #region ticketera
            if (Convert.ToInt16(CboTipoComprobante.ComboBox.SelectedValue) == 3)//es ticket
            {
                ...
                "Ticket Nro: ", DtDetalleComprobante, RUC, AppSettings.Usuario, TotalPagar, NomCaja, SerieEticketera,
                NroAutorizacion, TotalComprobanteLetras, ((TxtNombresRapido.Text.Trim() == "") ? TxtRazonSocial.Text : TxtNombresRapido.Text.Trim()),
                TxtNroDocumentoCliente.Text, TxtDireccion.Value.ToString(),
                TxtCanasta.Text, ConCliente, FECHA_IMPRESION, Convert.ToDecimal(TxtMontoPagado.Text), Convert.ToDecimal(TxtIGV.Text), TipoTicket, TotalComprobante);
        ...
        private void Calcular()
        {
            ...
            {
                TdgDocumento.Columns["Importe"].Value = decimal.Round(Convert.ToDecimal(TdgDocumento.Columns["Cantidad"].Value) * Convert.ToDecimal(TdgDocumento.Columns["PrecioUnitario"].Value), 2);
            }
        }
        #endregion
        ...
        //private DataTable VerificarCierre(int Cajero)
        //{
        //    DataTable DtCierre = new DataTable();
        //    DtCierre = ObjCL_Venta.VerificarCierre(Cajero);
        //    return DtCierre;
        ...
        private void BtnRegistroClienteRapido_Click(object sender, EventArgs e)
        {
            PnlUsuarioRapido.Visible = true;
        }

        private void BtnCerrarRapido_Click(object sender, EventArgs e)
        {
            PnlUsuarioRapido.Visible = false;
        }
        ...
        private void BtnBuscarCliente_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (DS.Tables[0].Rows.Count == 1)
                {
                    ...
                    TxtNroDocumentoCliente.Text = dtres.Rows[0]["NroDocumento"].ToString();
                ...
                {
                    DataTable dtres = DS.Tables[0].Copy();
                    TdgClientes.Visible = true;
                    TdgClientes.SetDataBinding(dtres, "", true);
                    TdgClientes.Focus();
        ...
        private void TdgClientes_KeyPress(object sender, KeyPressEventArgs e)
        {


            if (e.KeyChar == (char)(Keys.Enter) & TdgClientes.RowCount > 0)
            {

                ClienteID = Convert.ToInt32(TdgClientes.Columns["ClienteID"].Value);
                DepartamentoId = Convert.ToInt32(TdgClientes.Columns["DepartamentoId"].Value);
                ProvinciaId = Convert.ToInt32(TdgClientes.Columns["ProvinciaId"].Value);
                DistritoId = Convert.ToInt32(TdgClientes.Columns["DistritoId"].Value);

                if (TdgClientes.Columns["FUENTE"].Value.ToString() == "CLIENTE" | TdgClientes.Columns["FUENTE"].Value.ToString() == "PADRON")
                {
                    TxtNroDocumentoCliente.Text = TdgClientes.Columns["NroDocumento"].Value.ToString();
                    TxtRazonSocial.Text = TdgClientes.Columns["RazonSocial"].Value.ToString();
                    TxtDireccion.Text = TdgClientes.Columns["Direccion"].Value.ToString();

                    NombreVia = TdgClientes.Columns["NombreVia"].Value.ToString();
                    DireccionNumero = TdgClientes.Columns["DireccionNumero"].Value.ToString();
                    DireccionInterior = TdgClientes.Columns["DireccionInterior"].Value.ToString();
        ...
        //        if (TxtDocumentoRapido.Text.Trim().Length != 8 | TxtDocumentoRapido.Text.Trim().Length != 11)
        //        {
        //            ErrProvider.SetError(TxtDocumentoRapido, "Ingrese un RUC o DNI válido");
        //            paso = false;
        //            return;
        //        }


        //        if (TxtDocumentoRapido.Text.Trim().Length == 8)
        //        {
        //            if (TxtPaternoRapido.Text.Trim() == "")
        //            {
        //                ErrProvider.SetError(TxtPaternoRapido, "Ingrese un apellido paterno válido");
        //                paso = false;
        //            }
        //            if (TxtNombresRapido.Text.Trim() == "")
        //            {
        //                ErrProvider.SetError(TxtNombresRapido, "Ingrese un apellido paterno válido");
        //                paso = false;
        //            }
        ...
        //            if (TxtNombresRapido.Text.Trim() == "")
        //            {
        //                ErrProvider.SetError(TxtNombresRapido, "Ingrese una razón social");
        //                paso = false;
        //            }
        //        }
        ...
        //            ObjCliente.NroDocumento = TxtDocumentoRapido.Text;
        //            if (TxtDocumentoRapido.Text.Trim().Length == 8)
        //            {
        //                ObjCliente.RazonSocial = TxtNombresRapido.Text + " " + TxtPaternoRapido.Text + " " + TxtMaternoRapido.Text;
        //                ObjCliente.Alias = TxtNombresRapido.Text + " " + TxtPaternoRapido.Text + " " + TxtMaternoRapido.Text;
        //            }
        //            else
        //            {
        //                ObjCliente.RazonSocial = TxtNombresRapido.Text;
        //                ObjCliente.Alias = TxtNombresRapido.Text;
        //            }


        //            ObjCliente.Direccion = TxtDireccionRapido.Text;

        //            ObjCliente.DistritoId = 1815;

        //            ObjCliente.ProvinciaId = 191;

        //            ObjCliente.DepartamentoId = 25;


        //            ObjCliente.Nombre1 = TxtNombresRapido.Text;
        //            ObjCliente.Nombre2 = "";
        //            ObjCliente.Apellido1 = TxtPaternoRapido.Text;
        //            ObjCliente.Apellido2 = TxtMaternoRapido.Text;
        //            ObjCliente.PaisId = 168;
        //            ObjCliente.NombreVia = "";

        //            //ObjCliente.DireccionViaId = Convert.ToInt16(CboVia.SelectedValue.ToString());
        //            ObjCliente.DireccionNumero = "";
        //            ObjCliente.DireccionInterior = "";
        //            ObjCliente.UsuarioID = AppSettings.UserID;
