    ...
    public partial class PagoComprobante : UITemplateAccess
    {
                    ...
                    case "1":
                        if (EmpresaID == "GH")
                        {
                            if (AppSettings.GHSerieDefectoBoleta != "")
                                CboSerieGuia.SelectedValue = AppSettings.GHSerieDefectoBoleta;
                        }
                        else if (EmpresaID == "IH")
                        {
                            if (AppSettings.IHSerieDefectoBoleta != "")
                                CboSerieGuia.SelectedValue = AppSettings.IHSerieDefectoBoleta;
                        }
                        else if (EmpresaID == "CH")
                        {
                            if (AppSettings.CHSerieDefectoBoleta != "")
                                CboSerieGuia.SelectedValue = AppSettings.CHSerieDefectoBoleta;
                        }
                        else if (EmpresaID == "AH")
                        {
                            if (AppSettings.AHSerieDefectoBoleta != "")
                                CboSerieGuia.SelectedValue = AppSettings.AHSerieDefectoBoleta;
                        }
                        break;
                    case "2":
                        if (EmpresaID == "GH")
                        {
                            if (AppSettings.GHSerieDefectoFactura != "")
                                CboSerieGuia.SelectedValue = AppSettings.GHSerieDefectoFactura;
                        }
                        else if (EmpresaID == "IH")
                        {
                            if (AppSettings.IHSerieDefectoFactura != "")
                                CboSerieGuia.SelectedValue = AppSettings.IHSerieDefectoFactura;
                        }
                        else if (EmpresaID == "CH")
                        {
                            if (AppSettings.CHSerieDefectoFactura != "")
                                CboSerieGuia.SelectedValue = AppSettings.CHSerieDefectoFactura;
                        }
                        else if (EmpresaID == "AH")
                        {
                            if (AppSettings.AHSerieDefectoFactura != "")
                                CboSerieGuia.SelectedValue = AppSettings.AHSerieDefectoFactura;
                        }
                        break;
                    case "3":
                        if (EmpresaID == "GH")
                        {
                            if (AppSettings.GHSerieDefectoTicket != "")
                                CboSerieGuia.SelectedValue = AppSettings.GHSerieDefectoTicket;
                        }
                        else if (EmpresaID == "IH")
                        {
                            if (AppSettings.IHSerieDefectoTicket != "")
                                CboSerieGuia.SelectedValue = AppSettings.IHSerieDefectoTicket;
                        }
                        else if (EmpresaID == "CH")
                        {
                            if (AppSettings.CHSerieDefectoTicket != "")
                                CboSerieGuia.SelectedValue = AppSettings.CHSerieDefectoTicket;
                        }
                        else if (EmpresaID == "AH")
                        {
                            if (AppSettings.AHSerieDefectoTicket != "")
                                CboSerieGuia.SelectedValue = AppSettings.AHSerieDefectoTicket;
                        }
                        break;
                }
        ...
        private void Generar()
        {
            try
            {
                ...
                int_FormaPago = Convert.ToInt32(cbFormaPago.SelectedValue);
                ...
                if (int_FormaPago == 1)
                {
                    if (ClienteID == 1 | ClienteID == 204 | ClienteID == 241 | ClienteID == 3032)
                    {
                        MessageBox.Show("Si es venta al crédito, debe exigir datos que identifiquen al cliente", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        return;
                    }
                }
                ...
                if (cbFormaPago.SelectedValue == null) { errValidar.SetError(cbFormaPago, "Seleccione el tipo de pago"); validarCheck = true; }
                else if (CboTipoPago.SelectedValue == null && cbFormaPago.SelectedValue.ToString() != "1")
                {
                    errValidar.SetError(CboTipoPago, "Seleccione la forma de pago");
                    validarCheck = true;
                }
                ...
                if (cbFormaPago.SelectedValue.ToString().Equals("1"))
                ...
                if (CboTipoPago.SelectedValue == null)
                    ...
                    formaPago = Convert.ToInt32(CboTipoPago.SelectedValue);
                ...
                if (int_FormaPago == 1)
                {
                    ...
                    ObjFrmCuotas.dec_MontoCuota = Total;
                ...
                if (int_FormaPago == 1)//es credito
                {
                    ObjComprobante.CreditoID = 0;
                ...
                else if (int_FormaPago == 2)//es contado
                {
                ...
                else
                {
                    ...
                    dt = new CL_Comprobante().InsertComprobante(ObjComprobante, dsPedido.Tables["detallePedido"], NumPedido, "D", DtValesConsumo, DtBoucher, DtNotaIngreso, DtCuotas);
        ...
        private void Cargar()
        {
            ...
            c1Combo.FillC1Combo1(cbFormaPago, new CL_Comprobante().getTipoPago(), "NomTipoPago", "TipoPagoID");
            c1Combo.FillC1Combo1(CboTipoPago, new CL_Comprobante().getFormaPago(), "NomFormaPago", "FormaPagoID");
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            if (ObjCL_Venta.HABILITADOFE2(EmpresaID))
            {
                if (hojaimpresa == 1)
                {
                    ...
                    {
                        //                        Formatoticketanterior = ObjCL_Venta.FormatoTicketFEAnterior(NomEmpresa, AppSettings.NomSede, NumComprobante.Substring(2),
                        ...
                        //"", ConCliente, FECHA_IMPRESION, Convert.ToDecimal(TxtMontoPagado.Text), TotalIGV, "B", Total, montoimpuestobolsa);
                        ...
                        Convert.ToInt32(cbFormaPago.SelectedValue), DtCuotas, null);
                    ...
                    else if (Convert.ToInt16(CboTipoComprobante.SelectedValue) == 5)//es factura
                    {
                        ...
                        //NroAutorizacion, TotalPagarLetras, dsPedido.Tables["Pedido"].Rows[0]["RazonSocial"].ToString(),
                        //dsPedido.Tables["Pedido"].Rows[0]["NroDocumento"].ToString(), dsPedido.Tables["Pedido"].Rows[0]["Direccion"].ToString(),
                        //"", ConCliente, FECHA_IMPRESION, Convert.ToDecimal(TxtMontoPagado.Text), TotalIGV, "F", Total, montoimpuestobolsa);
                        //e.Graphics.DrawString(Formatoticketanterior, TxtFormatoticketera.Font, Brushes.Black, 0, 0); //total pagar en letras 
                        ...
                        DtDatosSede.Rows[0]["TelefonoCelular"].ToString(), DtDatosSede.Rows[0]["TelefonoFijo"].ToString(), Total,
                        montoimpuestobolsa, Convert.ToInt32(cbFormaPago.SelectedValue), DtCuotas, null);
                ...
                else if (hojaimpresa == 2)
                {
                    ...
                    if (Convert.ToInt16(CboTipoComprobante.SelectedValue) == 4)//es boleta
                    {
                        ...
                        NroAutorizacion, TotalPagarLetras, dsPedido.Tables["Pedido"].Rows[0]["RazonSocial"].ToString(),
                        dsPedido.Tables["Pedido"].Rows[0]["NroDocumento"].ToString(), dsPedido.Tables["Pedido"].Rows[0]["Direccion"].ToString(),
                        "", ConCliente, FECHA_IMPRESION, Convert.ToDecimal(TxtMontoPagado.Text), Convert.ToDecimal(TotalIGV), "B",
                        Total, montoimpuestobolsa, Convert.ToInt32(cbFormaPago.SelectedValue), DtCuotas, null);
                    ...
                    else if (Convert.ToInt16(CboTipoComprobante.SelectedValue) == 5)//es factura
                    {
                        ...
                        NroAutorizacion, TotalPagarLetras, dsPedido.Tables["Pedido"].Rows[0]["RazonSocial"].ToString(),
                        dsPedido.Tables["Pedido"].Rows[0]["NroDocumento"].ToString(), dsPedido.Tables["Pedido"].Rows[0]["Direccion"].ToString(),
                        "", ConCliente, FECHA_IMPRESION, Convert.ToDecimal(TxtMontoPagado.Text), Convert.ToDecimal(TotalIGV), "F",
                        Total, montoimpuestobolsa, Convert.ToInt32(cbFormaPago.SelectedValue), DtCuotas, null);
                ...
                //    NroAutorizacion, TotalPagarLetras, dsPedido.Tables["Pedido"].Rows[0]["RazonSocial"].ToString(),
                //    dsPedido.Tables["Pedido"].Rows[0]["NroDocumento"].ToString(), dsPedido.Tables["Pedido"].Rows[0]["Direccion"].ToString(),
                //    "", ConCliente, FECHA_IMPRESION, Convert.ToDecimal(TxtMontoPagado.Text), TotalIGV, "B", Total);
                //    e.Graphics.DrawString(Formatoticket, TxtFormatoticketera.Font, Brushes.Black, 0, 0); //total pagar en letras
                //    //e.Graphics.DrawString(Convert.ToChar(27) + "i", TxtPrecio.Font, Brushes.Black, 0, 0); //total pagar en letras
                //}
                //else if (Convert.ToInt16(CboTipoComprobante.SelectedValue) == 5)//es factura
                //{
                ...
                //    NroAutorizacion, TotalPagarLetras, dsPedido.Tables["Pedido"].Rows[0]["RazonSocial"].ToString(),
                //    dsPedido.Tables["Pedido"].Rows[0]["NroDocumento"].ToString(), dsPedido.Tables["Pedido"].Rows[0]["Direccion"].ToString(),
                //    "", ConCliente, FECHA_IMPRESION, Convert.ToDecimal(TxtMontoPagado.Text), TotalIGV, "F", Total);
                //    e.Graphics.DrawString(Formatoticket, TxtFormatoticketera.Font, Brushes.Black, 0, 0); //total pagar en letras
                //    //e.Graphics.DrawString(Convert.ToChar(27) + "i", TxtPrecio.Font, Brushes.Black, 0, 0); //total pagar en letras
                //}
                //return;
            ...
            if (Convert.ToInt16(CboTipoComprobante.SelectedValue) == 3)//es ticket
            {
                ...
                string Formatoticket2 = ObjCL_Venta.FormatoTicketBoleta(NomEmpresa, AppSettings.NomSede, NumComprobante.Substring(2),
                    "Ticket Nro: ", dsPedido.Tables["detallePedido"], RUC, AppSettings.Usuario, TotalPagar, NomCaja, SerieEticketera,
                    NroAutorizacion, TotalPagarLetras, lblCliente.Text, lblDocumento.Text, lblDireccion.Text, "",
                    ConCliente, FECHA_IMPRESION, Convert.ToDecimal(TxtMontoPagado.Text), TotalIGV, TipoTicket, Total);
            ...
            else if (Convert.ToInt16(CboTipoComprobante.SelectedValue) == 2)//es factura
            {
                ...
                e.Graphics.DrawString(lblTotVenta.Text, txtNumPedido.Font, Brushes.Black, 790 + AppSettings.FacturaEjeX, 477 + AppSettings.FacturaEjeY, formato); //total
        ...
        private void BtnDefault_Click(object sender, EventArgs e)
        {
            ...
            if (CboSerieGuia.SelectedIndex != -1)
            {
                ...
                switch (CboTipoComprobante.SelectedValue.ToString())
                {
                    case "1":
                        if (EmpresaID == "GH")
                            ObjUpdateConfiguration.AppSettingsSectionModify("GHSerieDefectoBoleta", CboSerieGuia.SelectedValue.ToString());
                        else if (EmpresaID == "IH")
                            ObjUpdateConfiguration.AppSettingsSectionModify("IHSerieDefectoBoleta", CboSerieGuia.SelectedValue.ToString());
                        else if (EmpresaID == "CH")
                            ObjUpdateConfiguration.AppSettingsSectionModify("CHSerieDefectoBoleta", CboSerieGuia.SelectedValue.ToString());
                        else if (EmpresaID == "AH")
                            ObjUpdateConfiguration.AppSettingsSectionModify("AHSerieDefectoBoleta", CboSerieGuia.SelectedValue.ToString());
                        break;
                    case "2":
                        if (EmpresaID == "GH")
                            ObjUpdateConfiguration.AppSettingsSectionModify("GHSerieDefectoFactura", CboSerieGuia.SelectedValue.ToString());
                        else if (EmpresaID == "IH")
                            ObjUpdateConfiguration.AppSettingsSectionModify("IHSerieDefectoFactura", CboSerieGuia.SelectedValue.ToString());
                        else if (EmpresaID == "CH")
                            ObjUpdateConfiguration.AppSettingsSectionModify("CHSerieDefectoFactura", CboSerieGuia.SelectedValue.ToString());
                        else if (EmpresaID == "AH")
                            ObjUpdateConfiguration.AppSettingsSectionModify("AHSerieDefectoFactura", CboSerieGuia.SelectedValue.ToString());
                        break;
                    case "3":
                        if (EmpresaID == "GH")
                            ObjUpdateConfiguration.AppSettingsSectionModify("GHSerieDefectoTicket", CboSerieGuia.SelectedValue.ToString());
                        else if (EmpresaID == "IH")
                            ObjUpdateConfiguration.AppSettingsSectionModify("IHSerieDefectoTicket", CboSerieGuia.SelectedValue.ToString());
                        else if (EmpresaID == "CH")
                            ObjUpdateConfiguration.AppSettingsSectionModify("CHSerieDefectoTicket", CboSerieGuia.SelectedValue.ToString());
                        else if (EmpresaID == "AH")
                            ObjUpdateConfiguration.AppSettingsSectionModify("AHSerieDefectoTicket", CboSerieGuia.SelectedValue.ToString());
                        break;
                }
        ...
        private void cbFormaPago_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            {
                if (cbFormaPago.SelectedValue.ToString() == "1")
                {
                    CboTipoPago.Text = "";
        ...
        private void CboTipoPago_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            if (CboTipoPago.SelectedIndex != -1 && CboTipoPago.SelectedValue.ToString() == "5")//es vale
            {
            ...
            else if (CboTipoPago.SelectedIndex != -1 && CboTipoPago.SelectedValue.ToString() == "3")//es boucher
            {
                //aca aparece la ventana de los vales
