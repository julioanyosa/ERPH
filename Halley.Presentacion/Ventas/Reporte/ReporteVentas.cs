...
namespace Halley.Presentacion.Ventas.Reporte
{
    public partial class ReporteVentas : UITemplateAccess
    {
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            string FormatoTotalesTicket = ObjCL_Venta.FormatoTickeCuadreCaja(Empresa, Sede, Cajero, totb, totf, tott + tottf, toti, tote, CajeroID, EmpresaID, SedeID, DS.Tables["Comprobante"], DineroEntregado, Entrega12, totbe, totfe);
        ...
        private void Imprimir_Click(object sender, EventArgs e)
        {
            if (TxtDineroEntregado.Text != "" && Convert.ToDecimal(TxtDineroEntregado.Text) != 0)
            {
                ...
                if (DV.Count > 0 & (tott + totb + totf + toti + totbe + totfe - tote) != 0 & DineroEntregado != 0)
                {
